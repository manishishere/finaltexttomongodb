...
exec("split -l 20000 -a 1 -d data.txt data/x", puts)
        ...
        function process1(file)
        {
                ...
                lr.on('line', function (line) {
                  ...
                  setTimeout(function () {
                           ...
                           // console.log(obj);
                            var s = new Sam(obj);
                            // Sam.update({DOI: temp[0]}, {$set:{DOI:temp[0],
                            //   Date_Ingested:temp[1],
                            //   Portico_Article_ID:temp[2],
                            //   Portico_Article_bibCitation:temp[3],
                            //   Triggered:temp[4] } },
          ...
          lr.on('end', function () {
              ...
              console.log(tt);
              console.log("total number of changes are:")
              console.log(checkcnt);
              fs.unlink(file);
            });
      }
